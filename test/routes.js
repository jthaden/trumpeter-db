...
describe('Trumpets', () => {
    ...
    describe('/POST trumpets', () => {
        it('should not POST a trumpet without user_info field', (done) => {
            let trumpet = {
            ...
            chai.request(server)
                ...
                .end((err, res) => {
                    ...
                    res.body.errors.should.have.property('user_info');
                    res.body.errors.user_info.should.have.property('kind').eql('required');
                    done();
                });
        });
        ...
        it('should POST a trumpet with default values', (done) => {
            var userInfo = new UserInfo({username: 'jthaden'});
            let trumpet = {
                user_info: userInfo,
                text: "PLS POST!"
            }
            chai.request(server)
                ...
                .end((err, res) => {
                    res.should.have.status(200);
                    res.body.should.be.a('object');
                    res.body.should.have.nested.property('finalTrumpet.user_info.username').eql('jthaden');
        ...
        it('should POST a trumpet with specific values', (done) => {
            var userInfo = new UserInfo({username: 'gandalf_the_gr@y'});
            let trumpet = {
                user_info: userInfo,
                text: "PLS POST 2!",
                likes: 6,
            ...
            chai.request(server)
                ...
                .end((err, res) => {
                    res.should.have.status(200);
                    res.body.should.be.a('object');
                    res.body.should.have.nested.property('finalTrumpet.user_info.username').eql('gandalf_the_gr@y');
                    res.body.should.not.have.nested.property('finalTrumpet.reply_trumpet_id');
                    res.body.should.have.nested.property('finalTrumpet.submit_time');
    ...
    describe('/GET/:id trumpet', () => {
        it('should GET a trumpet with the provided id', (done) => {
            var userInfo = new UserInfo({username: 'fro_doe'});
            ...
            trumpet.save((err, finalTrumpet) => {
                ...
                .end((err, res) => {
                    res.should.have.status(200);
                    res.body.should.be.a('object');
                    res.body.should.have.nested.property('trumpet.user_info.username').eql('fro_doe');
    ...
    describe('/PUT/:id trumpet likes', () => {
        it('should INCREMENT BY 1 the like count of a trumpet with provided id', (done) => {
            var userInfo = new UserInfo({username: 'golyum'});
            let trumpet = new Trumpet({
                user_info: userInfo,
            ...
            trumpet.save((err, finalTrumpet) => {
                ...
                .end((err, res) => {
                    ...
                    res.body.should.have.nested.property('finalTrumpet.user_info.username').eql(finalTrumpet.user_info.username);
                    res.body.should.not.have.nested.property('finalTrumpet.reply_trumpet_id');
                    res.body.should.have.nested.property('finalTrumpet.submit_time');
    ...
    describe('/DELETE/:id trumpet', () => {
        it('should DELETE a trumpet with provided id', (done) => {
            var userInfo = new UserInfo({username: 'sauryawn'});
            let trumpet = new Trumpet({
                user_info: userInfo,
                text: "DELETE ME!",
                likes: 555,
